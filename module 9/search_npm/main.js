...
function onInput(event) {
    ...
    if (value === "") {
        ...
        const resultOfSearch = names.filter(name => {
            ...
            return `<p><a target="_blank" href="https://www.google.com/search?q=${name}">${name}</a></p>`
        });
